...
class GamepadEmulator():
    def __init__(self) -> None:
        ...
        self.controller_socket = ControllerSocket(host=settings.WS_SERVER_HOST , port=settings.WS_SERVER_PORT)
    ...
    def interpolate_joystick_value(self,value):
        return int(interp(x=value,xp=self.JOYSTICKS_INPUT_SPAN, fp=self.JOYSTICKS_OUTPUT_SPAN))
