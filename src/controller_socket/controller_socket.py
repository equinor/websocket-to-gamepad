...
class ControllerSocket:
    ...
    def _on_message(self, ws_app, message):
        ...
        js_left_x = message["payload"]["joystick_01"]
        js_left_y = message["payload"]["joystick_02"]
        js_right_x = message["payload"]["joystick_03"]
        js_right_y = message["payload"]["joystick_04"]
